...
def get_db_connection():
    # Pega a string de conexão do banco de dados da variável de ambiente DB_CONNECTION
    conn_str = os.getenv('DB_CONNECTION')  # Lê a variável de ambiente DB_CONNECTION
    
    # Se a variável de ambiente não estiver definida, retorna erro
    if conn_str is None:
        raise ValueError("DB_CONNECTION não está configurada corretamente.")
